...
import { accountingPastPaper2023 } from './accounting-past-paper-2023';
import { accountingPastPaper2023P2 } from './accounting-past-paper-2023-p2';
import { accountingPastPaper2024P1 } from './accounting-past-paper-2024-p1';
import { accountingPastPaper2025P1 } from './accounting-past-paper-2025-p1';
import { accountingPastPaper2025P2 } from './accounting-past-paper-2025-p2';
...
export interface Booklet {
  ...
  description: string;
  totalMarks: number;
  /** Categorises the resource so the UI can apply distinct badges/sections */
  type?: 'tutorial' | 'practice' | 'past-paper';
  /** Optional year for past papers (e.g. 2023) */
  year?: number;
  sections: Section[];
  revisionNotes?: {
    title: string;
...
// Past papers collection (must be declared before `subjects` so the array initialiser can reference it)
export const accountingPastPapers: Booklet[] = [
  { ...accountingPastPaper2023, type: 'past-paper' as const, year: 2023 },
  { ...accountingPastPaper2023P2, type: 'past-paper' as const, year: 2023 },
  { ...accountingPastPaper2024P1, type: 'past-paper' as const, year: 2024 },
  { ...accountingPastPaper2025P1, type: 'past-paper' as const, year: 2025 },
  { ...accountingPastPaper2025P2, type: 'past-paper' as const, year: 2025 },
];
...
export const subjects: Subject[] = [
  ...
  },
  {
    ...
    booklets: [...accountingTutorials, ...accountingBooklets, ...accountingPastPapers],
  },
  {
    id: 'physics',
    name: 'Physics',
